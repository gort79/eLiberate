...
var PluginAPI = function () {
  function PluginAPI(base, filteredArgs, program) {
    ...
    this._runHooks = function () {
      var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(handlers, hookName) {
    ...
    this._runPostHooks = function () {
      var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(commandName) {
        var hookName, hookList;
