...
(0, _mocha.describe)('module - meteor', function () {
  ...
  (0, _mocha.describe)('setup', function () {
    ...
    (0, _mocha.it)('should setup environment on "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
  ...
  (0, _mocha.describe)('push', function () {
    ...
    (0, _mocha.it)('should push meteor app bundle to "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
      var serverInfo, out, num, sshOut;
  ...
  (0, _mocha.describe)('envconfig', function () {
    ...
    (0, _mocha.it)('should send the environment variables to "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
    ...
    (0, _mocha.it)('should push server specific env variables', _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {
      var out, sshOut;
  ...
  (0, _mocha.describe)('start', function () {
    ...
    (0, _mocha.it)('should start meteor on "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee5() {
      var out, num, sshOut;
  ...
  (0, _mocha.describe)('deploy', function () {
    ...
    var checkDeploy = function () {
      var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(out, appText) {
    ...
    (0, _mocha.it)('should deploy meteor app on "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee7() {
      var out;
    ...
    (0, _mocha.it)('should deploy app using Meteor 1.2', _asyncToGenerator(regeneratorRuntime.mark(function _callee8() {
      var out;
  ...
  (0, _mocha.describe)('logs', function () {
    ...
    (0, _mocha.it)('should pull the logs from "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee9() {
      var out;
  ...
  (0, _mocha.describe)('stop', function () {
    ...
    var serverInfo = servers['mymeteor'];
    (0, _mocha.it)('should stop meteor app on "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee10() {
      var out, num, sshOut;
