...
(0, _mocha.describe)('module - default', function () {
  ...
  (0, _mocha.describe)('deploy', function () {
    ...
    (0, _mocha.it)('should deploy meteor app on "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
  ...
  (0, _mocha.describe)('reconfig', function () {
    ...
    (0, _mocha.it)('should reconfig meteor app on "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
      var serverInfo, out;
  ...
  (0, _mocha.describe)('restart', function () {
    ...
    (0, _mocha.it)('should restart meteor app on "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
      var serverInfo, out;
  ...
  (0, _mocha.describe)('setup', function () {
    ...
    (0, _mocha.it)('should setup "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {
      var serverInfo, out;
  ...
  (0, _mocha.describe)('start', function () {
    ...
    (0, _mocha.it)('should start meteor app on "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee5() {
      var serverInfo, out;
  ...
  (0, _mocha.describe)('stop', function () {
    ...
    (0, _mocha.it)('should stop meteor app on "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee6() {
      var serverInfo, out;
  ...
  (0, _mocha.describe)('syslog', function () {
    ...
    (0, _mocha.it)('should write meteor logst to syslog on "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee7() {
      var out;
