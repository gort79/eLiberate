...
(0, _mocha.describe)('module - proxy', function () {
  ...
  (0, _mocha.describe)('setup', function () {
    ...
    (0, _mocha.it)('should setup proxy on "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
      var serverInfo, out;
  ...
  (0, _mocha.describe)('reconfig-shared', function () {
    (0, _mocha.it)('it should update shared settings', _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
      var serverInfo, out;
