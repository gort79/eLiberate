...
(0, _mocha.describe)('module - mongo', function () {
  ...
  (0, _mocha.describe)('logs', function () {
    ...
    (0, _mocha.it)('should pull logs from "meteor" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
      var out;
  ...
  (0, _mocha.describe)('setup', function () {
    ...
    (0, _mocha.it)('should setup mongodb on "mongo" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
  ...
  (0, _mocha.describe)('start', function () {
    ...
    (0, _mocha.it)('should start mongodb on "mongo" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
      var serverInfo, out;
  ...
  (0, _mocha.describe)('stop', function () {
    ...
    (0, _mocha.it)('should stop mongodb on "mongo" vm', _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {
      var serverInfo, out;
